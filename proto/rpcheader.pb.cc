...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::amoureux_proto::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::amoureux_proto::RpcHeader, _impl_.service_name_),
  PROTOBUF_FIELD_OFFSET(::amoureux_proto::RpcHeader, _impl_.method_name_),
  PROTOBUF_FIELD_OFFSET(::amoureux_proto::RpcHeader, _impl_.args_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::amoureux_proto::RpcHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::amoureux_proto::_RpcHeader_default_instance_._instance,
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\016amoureux_proto\"I\n\tRpc"
  "Header\022\024\n\014service_name\030\001 \001(\014\022\023\n\013method_n"
  "ame\030\002 \001(\014\022\021\n\targs_size\030\003 \001(\rB\003\200\001\001b\006proto"
  "3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_rpcheader_2eproto = {
    false, false, 121, descriptor_table_protodef_rpcheader_2eproto,
    "rpcheader.proto",
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:amoureux_proto.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:amoureux_proto.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:amoureux_proto.RpcHeader)
...
// @@protoc_insertion_point(message_clear_start:amoureux_proto.RpcHeader)
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:amoureux_proto.RpcHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:amoureux_proto.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:amoureux_proto.RpcHeader)
  size_t total_size = 0;
...
void RpcHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:amoureux_proto.RpcHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:amoureux_proto.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::amoureux_proto::RpcHeader*
Arena::CreateMaybeMessage< ::amoureux_proto::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::amoureux_proto::RpcHeader >(arena);
}
